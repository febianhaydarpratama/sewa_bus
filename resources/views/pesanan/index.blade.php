...
<div class="form-search" style="float:right">
    <form action="{{ route('pesanan.search') }}" method="get" accept-charset="utf-8">
        <div class="form-group" style="display:flex">
            <input type="search" id="nama" name="nama" class="form-control" placeholder="Cari Data Pesanan">
    ...
    <tbody>
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    <a href="{{ route('pesanan.edit', $data->id_pesanan) }}" type="button" class="btn btn-warning rounded-3">Ubah</a>

                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $data->id_pesanan }}">
                        Hapus
                    </button>
                    ...
                    <div class="modal fade" id="hapusModal{{ $data->id_pesanan }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('pesanan.hide', $data->id_pesanan) }}">
                                    @csrf
